...
import GitHubRepoCard from "@/app/Components/docs/GitHubRepoCard";

<GitHubRepoCard />

For detailed instructions on cloning and setting up the repository, check out the [Clone Starter Repository Guide](/docs/clone-starter-repo).
