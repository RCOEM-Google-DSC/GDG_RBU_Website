      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="relative border-l border-neutral-300 dark:border-neutral-700 ml-3 md:ml-0 space-y-12">
            <ExperienceItem 
                ...
                description="Leading the core infrastructure team. Migrated legacy monolithic architecture to microservices using Go and gRPC, improving system throughput by 300%. Mentoring 4 junior developers."
                isLatest={true}
            />
             <ExperienceItem 
                ...
                description="Developed award-winning interactive websites for Fortune 500 clients. Specialized in WebGL animations and optimizing render performance for mobile devices."
            />
             <ExperienceItem 
                role="Machine Learning Intern"
                period="2018"
                company="DataCorp"
                description="Assisted in training NLP models for customer sentiment analysis. Cleaned large datasets and implemented data pipelines using Python Pandas."
            />
        </div>
      </div>
    </section>
