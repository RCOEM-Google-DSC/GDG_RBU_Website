        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="inline-block border-b border-gray-300 dark:border-gray-600 pb-2 mb-8">
              <span className="text-xs font-semibold tracking-[0.2em] uppercase">Technical Proficiency</span>
            </div>
            <h2 className="font-display text-4xl mb-8">
              The tools I use to <span className="italic font-normal">create.</span>
            </h2>
            
            <div className="space-y-10">
              {SKILL_CATEGORIES.map((category) => (
                <div key={category.title}>
                  <h3 className="font-display text-xl mb-4 italic">{category.title}</h3>
