...
export default async function UpcomingEventDetailPage({ params }: PageProps) {
    ...
    const eventEntryFee = 'entry_fee' in event ? (event as any).entry_fee as string : 'Free'; // Assuming entry_fee key exists or default to Free
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
                            ...
                            <div className="p-4 md:p-6 flex items-center gap-3 group hover:bg-gray-50 transition-colors cursor-default">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900 font-semibold text-sm truncate max-w-[120px]" title={eventLocation}>{eventLocation}</p>
                                </div>
                            </div>
                            <div className="p-4 md:p-6 flex items-center gap-3 group hover:bg-gray-50 transition-colors cursor-default">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900 font-semibold text-sm">{eventEntryFee}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
                    ...
                    <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                        <div>
                            ...
                            <div className="prose prose-gray max-w-none text-gray-600 text-base leading-relaxed space-y-3">
                                ...
                                <p>
                                    Whether you're a beginner exploring cloud concepts or an advanced developer looking to master Kubernetes, this event has something for everyone. We will cover topics ranging from <span className="text-gray-900 font-semibold">Generative AI, Serverless Architectures, to Big Data Analytics</span>.
                                </p>
                            </div>
                        </div>
                    ...
                    <section className="py-4">
                        <div className="max-w-4xl mx-auto">
                            <h2 className="text-2xl font-bold mb-10 text-center text-gray-900">Registration Process</h2>
                            ...
                            <div className="relative flex flex-col md:flex-row justify-between items-start md:items-center px-4 md:px-0">
                                ...
                                {[
                                    ...
                                    <div key={index} className="flex flex-row md:flex-col items-center gap-5 w-full md:w-auto mb-6 md:mb-0 bg-[#FDFCF8] md:bg-transparent p-2 md:p-0 rounded-xl relative z-10 group cursor-default">
                                        {/* Circle */}
                                        ...
                                        <div className="text-left md:text-center">
                                            <h3 className="text-sm font-bold text-gray-900 mb-0.5 group-hover:text-blue-600 transition-colors">{item.title}</h3>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:border-blue-500/30 hover:shadow-md transition-all">
                                ...
                                <h3 className="text-lg font-bold text-gray-900 mb-1.5">Team Up</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">Form teams of up to 4 members. Join our Discord to find teammates.</p>
                            </div>
                            <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:border-green-500/30 hover:shadow-md transition-all">
                                ...
                                <h3 className="text-lg font-bold text-gray-900 mb-1.5">Learn</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">Attend at least 3 technical sessions to unlock the "Learner" badge.</p>
                            </div>
                            <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm hover:border-yellow-500/30 hover:shadow-md transition-all">
                                ...
                                <h3 className="text-lg font-bold text-gray-900 mb-1.5">Conquer</h3>
                                <p className="text-gray-500 text-sm leading-relaxed">Complete 5 hands-on labs to earn certification & win prizes.</p>
                            </div>
                        </div>
                    </section>
                                ...
                                <div className="relative z-10 flex flex-col h-full justify-between">
                                    <div>
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <h3 className="text-xl font-bold text-gray-900">Official Certification</h3>
                                        </div>
                                    ...
                                    <div className="w-full h-48 md:h-64 bg-white rounded-xl border border-gray-200 relative overflow-hidden shadow-sm group-hover:shadow-md transition-all duration-500">
                                        ...
                                        <div className="absolute inset-4 border-2 border-double border-gray-200 rounded-lg flex flex-col items-center justify-center p-6 text-center">
                                            ...
                                            <h4 className="text-gray-900 font-serif text-lg tracking-wide mb-1">Certificate of Completion</h4>
                                            <p className="text-gray-400 text-[10px] uppercase tracking-widest mb-4">Presented to</p>
                                            <span className="text-2xl font-serif text-blue-600 font-bold italic">John Doe</span>
                                            <div className="mt-auto w-full flex justify-between items-end opacity-50">
                                                <div className="flex flex-col gap-1">
                                                    <div className="h-0.5 w-16 bg-gray-300"></div>
                                                    <span className="text-[8px] text-gray-400">Organizer</span>
                                                </div>
                            ...
                            <div className="lg:col-span-1 flex flex-col h-full">
                                <div className="bg-white border border-gray-200 rounded-3xl p-6 relative overflow-hidden h-full flex flex-col shadow-sm">
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <div>
                                            <h3 className="text-xl font-bold text-gray-900">Exclusive Swag</h3>
                                    ...
                                    <div className="flex flex-col gap-4 grow justify-center">
                                        {[
                                            { name: "Diary", icon: Book, color: "text-blue-600", bg: "bg-blue-100" },
                                            { name: "T-Shirt", icon: Shirt, color: "text-blue-600", bg: "bg-blue-100" },
                                            { name: "Stickers", icon: Smile, color: "text-yellow-600", bg: "bg-yellow-100" },
                                            { name: "Badge", icon: Award, color: "text-purple-600", bg: "bg-purple-100" },
                                        ].map((item, i) => (
                                            <div key={i} className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 transition-colors group/item cursor-default border border-transparent hover:border-gray-100">
                                                ...
                                                <span className="text-sm font-medium text-gray-700 group-hover/item:text-gray-900 transition-colors">{item.name}</span>
                                            </div>
                                        ))}
                                    </div>
                                </div>
