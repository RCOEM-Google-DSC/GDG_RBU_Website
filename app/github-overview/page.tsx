...
const CopyButton: React.FC<{ text: string }> = ({ text }) => {
  ...
  return (
    <button
      onClick={handleCopy}
      className="absolute top-1/2 -translate-y-1/2 right-2 p-2 bg-white border-2 border-black hover:bg-yellow-300 transition-colors shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-1 active:shadow-none"
      title="Copy command"
    >
      {copied ? (
...
const StepCard: React.FC<StepCardProps> = ({
  ...
  <div
    className={`bg-white border-4 border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transform md:${rotate} rotate-0 md:hover:rotate-0 transition-transform duration-300 relative ${className}`}
  >
    <div className="absolute -top-5 -left-5 bg-yellow-300 border-4 border-black w-12 h-12 flex items-center justify-center font-black text-2xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
      {number}
    </div>
    <div className="mb-4 flex justify-between items-start pt-2">
      <h3 className="text-2xl font-black uppercase leading-none">{title}</h3>
      <Icon size={32} strokeWidth={2.5} className="text-[#8338ec]" />
    </div>
...
const ScreenshotPlaceholder: React.FC<{
  ...
  if (Array.isArray(items) && items.length > 0) {
    slides = items.map((it) =>
      typeof it === "string" ? { src: it } : { src: it.src }
    );
        ...
        <>
          {hasPrev && (
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 bg-white text-black p-2 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] active:translate-y-0 active:shadow-none transition-all z-30"
          ...
          {hasNext && (
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-white text-black p-2 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] active:translate-y-0 active:shadow-none transition-all z-30"
              title="Next Image"
            >
              <ArrowRight size={24} />
            </button>
  ...
  return (
    <div className="min-h-screen text-black relative overflow-hidden font-['Gesit','Gesit-Regular',sans-serif] selection:bg-yellow-300 selection:text-black bg-[#f0f0f0] pb-20">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <DecoCross className="hidden md:block absolute top-20 right-20 w-16 h-16 text-black opacity-100 rotate-12" />
        <DecoCross className="hidden md:block absolute bottom-40 left-10 w-24 h-24 text-[#8338ec] opacity-100 -rotate-12" />
      ...
      <div className="max-w-6xl mx-auto px-6 pt-16 md:pt-24 mb-16 relative z-10">
        <div className="bg-[#ffbe0b] border-4 border-black p-8 md:p-12 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transform md:-rotate-1 rotate-0 relative">
          <DecoZigZag className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-48 h-8 text-[#8338ec]" />

          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <div className="inline-block bg-black text-white px-4 py-1 text-xl font-bold mb-4 md:rotate-2 rotate-0">
                THE ONE TRUE METHOD
              </div>
            ...
            <div className="bg-black p-4 rounded-xl md:rotate-2 rotate-0 md:hover:-rotate-1 transition-all duration-300 w-full md:w-auto">
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-24 relative z-10">
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              <p className="mb-4">
                Create a new local repository. This tells Git to start watching
                your folder.
              </p>
            ...
            >
              <p className="mb-4">
                Select the files you want to save. The{" "}
                <span className="bg-yellow-300 px-1">.</span> adds everything.
              </p>
            ...
            >
              <p className="mb-4">
                Link your local repo to the specific GitHub URL. This builds the
                bridge.
              </p>
              <CommandBlock
            ...
            >
              <p className="mb-4">
                Send your commits to the cloud. The{" "}
                <code className="bg-yellow-300 font-bold px-1">-u</code>{" "}
                remembers where you pushed for next time.
              </p>
              <CommandBlock
        ...
        <section className="relative">
          <div className="absolute -top-10 -right-10 hidden md:block">
            <Coffee
              size={120}
              strokeWidth={1}
              className="text-orange-200 rotate-12"
            />
          </div>

          <div className="bg-[#1a1a1a] text-white p-6 md:p-12 border-4 border-black shadow-[16px_16px_0px_0px_#8338ec] relative overflow-hidden">
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row gap-6 md:items-end mb-12 border-b-2 border-gray-700 pb-8">
                <div>
                  ...
                  <p className="text-gray-400 font-mono text-lg">
                    Scenario: You wrote your first Hello World and need to flex
                    it.
                  </p>
                </div>
                <div className="bg-orange-500 text-black font-bold px-4 py-2 md:transform md:rotate-3 rotate-0 border-2 border-white">
                  LIVE WALKTHROUGH
                </div>
              </div>

              <div className="mb-16">
                <div className="inline-block bg-[#f89820] text-black px-4 py-1 font-black mb-4 uppercase text-lg transform -rotate-1 md:-rotate-1 rotate-0">
                  0. The Context
                </div>
                <div className="flex flex-col lg:flex-row gap-6 items-start">
                  <div className="flex-1 w-full">
                    ...
                    <div className="bg-gray-800 rounded-lg border-2 border-gray-600 p-6 font-mono text-sm leading-relaxed overflow-x-auto shadow-[8px_8px_0px_0px_rgba(255,255,255,0.1)]">
                      ...
                      <br />
                      &nbsp;&nbsp;&nbsp;&nbsp;System.out.println(
                      <span className="text-green-300">"Hello GitHub!"</span>);
                      <br />
                      &nbsp;&nbsp;{"}"}
                      <br />
                      {"}"}
              ...
              <div className="space-y-20">
                ...
                <div className="border-l-4 border-[#f89820] pl-6 md:pl-10 relative">
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    <CommandBlock
                      command={'git commit -m "Added hello world"'}
                    />
                    <ScreenshotPlaceholder
                      onImageClick={openLightbox}
                      items={[
        ...
        <section>
          <div className="flex justify-center mb-8">
            <h2 className="text-3xl font-black bg-yellow-300 px-8 py-4 border-4 border-black rotate-1 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              REPOSITORY GALLERY
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {REPO_IMAGES.map((src, i) => (
              <div
                key={i}
                className="group bg-white p-4 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-2 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all"
              >
                <div className="h-48 bg-gray-100 border-2 border-black mb-4 flex items-center justify-center relative overflow-hidden">
                  ...
                  />
                  <div className="absolute bottom-2 right-2 bg-green-500 text-white text-xs font-bold px-2 py-1 rotate-12 border border-black shadow-sm">
                    VIEW
                  </div>
                </div>
      ...
      {lightbox.open && (
        ...
        >
          ...
          <div
            className="relative z-10 max-w-6xl w-full max-h-[90vh] bg-white border-4 border-black p-2 shadow-[10px_10px_0px_0px_#ffbe0b] cursor-default animate-in fade-in zoom-in duration-300"
