...
export function Feedback({
  ...
  const [feedbackList, setFeedbackList] =
    useState<FeedbackType[]>(initialFeedback);
        ...
        <div className="mb-8">
          <input
            ...
            className={nb({
              ...
              shadow: "sm",
              className:
                "w-full p-4 font-medium mb-4 focus:outline-none focus:ring-4 ",
            })}
          />
          <textarea
            value={message}
            ...
            className={nb({
              ...
              shadow: "sm",
              className:
                "w-full p-4 font-medium resize-none focus:outline-none focus:ring-4 ",
            })}
            rows={4}
          />
          <button
