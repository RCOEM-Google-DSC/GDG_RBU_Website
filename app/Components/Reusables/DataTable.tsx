...
import {ArrowDown, ArrowUp, ArrowUpDown, ChevronDown, Filter, LayoutGrid, TableIcon,} from "lucide-react";
        ...
        <div>
            ...
            <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    ...
                    {hasFilters &&
                        ...
                        filters
                            ...
                            .map((filter) => (
                                ...
                                >
                                    <SelectTrigger
                                        className="h-9 cursor-pointer w-auto rounded-md border border-input bg-background px-2 text-sm">
                                    ...
                                    <Popover key={filter.id}>
                                        <PopoverTrigger asChild>
                                            ...
                                            >
                                                ...
                                                {selectedCount > 0 && (
                                                    <span
                                                        className="ml-1 rounded-sm bg-primary px-1 text-xs text-primary-foreground">
                            {selectedCount}
                          </span>
                                                )}
                ...
                <div className="flex items-center gap-2 ">
                    ...
                    >
                        <SelectTrigger
                            className="h-8 cursor-pointer rounded-md border border-input bg-background px-2 text-sm">
                            <SelectValue/>
                        </SelectTrigger>
                        <SelectContent>
