  ...
  return (
    ...
    >
      <div className="size-full flex items-center justify-center">
        <div className="max-w-7xl w-full overflow-hidden" style={{
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 flex flex-col justify-center">
              <div className="space-y-4 sm:space-y-5 md:space-y-6">
                {/* Heading */}
                <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl xl:text-6xl font-black leading-tight" style={{ color: "#000000" }}>
                  Meet the Google Developer Group Team
                </h1>

                {/* Paragraph Text */}
                <p className="text-sm sm:text-base md:text-sm lg:text-base leading-relaxed font-medium" style={{ color: "#000000" }}>
                ...
                <div className="space-y-4 sm:space-y-5 md:space-y-6 pt-2 sm:pt-3 md:pt-4">
                  <div className="flex gap-3 sm:gap-4">
                    ...
                    <CheckCircle className="w-8 h-8 sm:w-10 sm:h-10" style={{ color: "#000000" }} />

                    <div>
                      <h3 className="text-base sm:text-lg md:text-base lg:text-lg mb-1 sm:mb-2 font-black" style={{ color: "#000000" }}>
