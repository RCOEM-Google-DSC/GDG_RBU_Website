...
export const Experience: React.FC<ExperienceProps> = ({ experience }) => {
    ...
    return (
        <section
            id="experience"
            className="py-24 bg-black border-b border-zinc-900"
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
                    ...
                    <div className="md:col-span-10 space-y-12">
                        {experience.map((item) => (
                            <div
                                key={item.id}
                                className="relative pl-8 md:pl-0 border-l border-zinc-800 md:border-l-0"
                            >
                                {/* Mobile Timeline Dot */}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 items-start">
                                    <div className="md:col-span-3">
                                        <span className="text-red-600 font-mono text-sm tracking-widest uppercase block mb-1">
                                            {item.period}
                                        </span>
