...
function RegisterPageContent() {
  ...
  useEffect(() => {
    const w =
      ...
      (cardStageRef.current ? cardStageRef.current.clientWidth : 0);
    const max = computeMaxTranslate(
      w || Math.min(window.innerWidth * 0.92, 380),
    );
    setTranslateX(mode === "login" ? max : 0);
  }, [mode]);
    ...
    <section className="relative h-[calc(100vh-70px)] overflow-hidden">
      ...
      >
        ...
        >
          ...
          <path
            d="M57.5 100.5H19C14.3056 100.5 10.5 104.306 10.5 109V143.5C10.5 150.404 16.0964 156 23 156C29.9036 156 35.5 161.596 35.5 168.5V196C35.5 204.284 42.2157 211 50.5 211H200C208.284 211 215 204.284 215 196V166.25C215 160.589 219.589 156 225.25 156C230.911 156 235.5 151.411 235.5 145.75V117.5C235.5 109.216 228.784 102.5 220.5 102.5H184.5C176.216 102.5 169.5 109.216 169.5 117.5V141C169.5 149.284 162.784 156 154.5 156H87.5C79.2157 156 72.5 149.284 72.5 141V115.5C72.5 107.216 65.7843 100.5 57.5 100.5Z"
            fill="black"
          />
          <path
            d="M52.5 96.5H14C9.30558 96.5 5.5 100.306 5.5 105V139.5C5.5 146.404 11.0964 152 18 152C24.9036 152 30.5 157.596 30.5 164.5V192C30.5 200.284 37.2157 207 45.5 207H195C203.284 207 210 200.284 210 192V162.25C210 156.589 214.589 152 220.25 152C225.911 152 230.5 147.411 230.5 141.75V113.5C230.5 105.216 223.784 98.5 215.5 98.5H179.5C171.216 98.5 164.5 105.216 164.5 113.5V137C164.5 145.284 157.784 152 149.5 152H82.5C74.2157 152 67.5 145.284 67.5 137V111.5C67.5 103.216 60.7843 96.5 52.5 96.5Z"
            fill="#34A853"
            stroke="black"
          />
          <path
            d="M92.5 95V74C92.5 65.7157 99.2157 59 107.5 59H111C119.284 59 126 52.2843 126 44V19.5C126 11.2157 132.716 4.5 141 4.5H175C183.284 4.5 190 11.2157 190 19.5V45.5C190 52.9558 183.956 59 176.5 59C169.044 59 163 65.0442 163 72.5V95C163 103.284 156.284 110 148 110H107.5C99.2157 110 92.5 103.284 92.5 95Z"
            fill="black"
          />
          <path
            d="M87.5 91V70C87.5 61.7157 94.2157 55 102.5 55H106C114.284 55 121 48.2843 121 40V15.5C121 7.21573 127.716 0.5 136 0.5H170C178.284 0.5 185 7.21573 185 15.5V41.5C185 48.9558 178.956 55 171.5 55C164.044 55 158 61.0442 158 68.5V91C158 99.2843 151.284 106 143 106H102.5C94.2157 106 87.5 99.284 87.5 91Z"
            fill="#FFC20E"
            stroke="black"
          />
          <path
            d="M198.5 224.5H51C42.7157 224.5 36 231.216 36 239.5V263C36 271.284 42.7157 278 51 278H151.5C159.784 278 166.5 284.716 166.5 293V320C166.5 328.284 159.784 335 151.5 335H72C63.7157 335 57 341.716 57 350V373C57 381.284 50.2843 388 42 388H20.5C12.2157 388 5.5 394.716 5.5 403V428C5.5 436.284 12.2157 443 20.5 443H45C53.2843 443 60 449.716 60 458V483C60 491.284 66.7157 498 75 498H253C261.284 498 268 491.284 268 483V293C268 284.716 261.284 278 253 278H228.5C220.216 278 213.5 271.284 213.5 263V239.5C213.5 231.216 206.784 224.5 198.5 224.5Z"
            fill="black"
          />
          <path
            d="M193.5 218.5H46C37.7157 218.5 31 225.216 31 233.5V257C31 265.284 37.7157 272 46 272H146.5C154.784 272 161.5 278.716 161.5 287V314C161.5 322.284 154.784 329 146.5 329H67C58.7157 329 52 335.716 52 344V367C52 375.284 45.2843 382 37 382H15.5C7.21573 382 0.5 388.716 0.5 397V422C0.5 430.284 7.21573 437 15.5 437H40C48.2843 437 55 443.716 55 452V477C55 485.284 61.7157 492 70 492H248C256.284 492 263 485.284 263 477V287C263 278.716 256.284 272 248 272H223.5C215.216 272 208.5 265.284 208.5 257V233.5C208.5 225.216 201.784 218.5 193.5 218.5Z"
            fill="#EA4335"
            stroke="black"
          />
          <path
            d="M179.5 383.5H144.5C136.216 383.5 129.5 390.216 129.5 398.5V422.5C129.5 430.784 136.216 437.5 144.5 437.5H179.5C187.784 437.5 194.5 430.784 194.5 422.5V398.5C194.5 390.216 187.784 383.5 179.5 383.5Z"
            fill="black"
            stroke="black"
          />
          <path
            d="M175.5 380.5H140.5C132.216 380.5 125.5 387.216 125.5 395.5V419.5C125.5 427.784 132.216 434.5 140.5 434.5H175.5C183.784 434.5 190.5 427.784 190.5 419.5V395.5C190.5 387.216 183.784 380.5 175.5 380.5Z"
            fill="#F8FDFA"
            stroke="black"
          />
        </svg>
      ...
      <div className="flex items-center justify-center h-full">
        <div className="relative">
          <div
            ref={cardStageRef}
            className="relative w-[92vw] max-w-[380px]"
          ...
          >
            <div
              ...
              style={{
                transition:
                  "opacity 420ms ease, transform 700ms cubic-bezier(.22,.9,.26,1)",
              }}
              className={`absolute inset-0 z-10 rounded-sm border-4 border-black shadow-[10px_10px_0_#000] p-8 bg-[#6F6EF6] ${mode === "login"
            ...
            <div
              ...
              className={`absolute inset-0 z-20 rounded-sm border-4 border-black shadow-[10px_10px_0_#000] p-8 bg-[#FFC20E] ${mode === "signup"
                  ? "opacity-100 translate-x-0"
                  : "opacity-0 translate-x-6 pointer-events-none"
                }`}
            >
          ...
          >
            <div className="relative w-[140px] h-14">
              <div
                className="absolute -right-2.5 -bottom-2.5 w-full h-full rounded-md"
                style={{
                  background: "#3B82F6",
              ...
              <button
                ...
                className={nb({
                  ...
                  rounded: "md",
                  className:
                    "relative z-20 w-full h-full bg-black text-white font-bold text-2xl",
                })}
              >
...
export default function RegisterPage() {
  return (
    <Suspense fallback={<div className="h-screen w-full flex items-center justify-center font-bold text-2xl">Loading...</div>}>
      <RegisterPageContent />
    </Suspense>
  );
}
